# Notices and Safety Disclaimer

Copyright © 2026 Gerardo R Padilla Jr.
...
The project is not affiliated with, endorsed by, or sponsored by any machine-tool, robotics, metrology, controls, or manufacturing-equipment vendor. Product and company names referenced by third-party dependencies remain the property of their respective owners.

## Warranty and liability

The project is provided under the MIT License and without warranty. See [LICENSE](LICENSE) for the controlling license terms. This notice supplements the project description and does not replace or modify the MIT License.
