...
- Simulation state, workpiece serials, telemetry, events, and KPIs are synthetic and remain in browser memory.
- Sound is generated locally with the Web Audio API and is disabled by default.
- The application does not intentionally store cookies, local-storage records, or personal information.
- No production or machine data should be entered into the simulator.
