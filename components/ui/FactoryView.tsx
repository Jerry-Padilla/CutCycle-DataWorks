...
export function FactoryView() {
  ...
  return (
    <section className="factory-view" aria-label="3D manufacturing cell">
      ...
      {!explore && <><HUD /><SimulationControls /><MachinePanel /><div className="scene-footer"><button className="button glass-panel" onClick={() => setExplore(true)}><Gamepad2 size={13} /> Explore mode</button><div className="control-help glass-panel">DRAG ORBIT · SCROLL ZOOM · TAP EQUIPMENT</div></div></>}
